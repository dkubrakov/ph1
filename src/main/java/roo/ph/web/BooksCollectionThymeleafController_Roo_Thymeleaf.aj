...
import roo.ph.web.BooksCollectionThymeleafController;
import roo.ph.web.BooksItemThymeleafController;
import roo.ph.web.BooksItemThymeleafLinkFactory;
...
privileged aspect BooksCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void BooksCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_book_name", null, "Name", locale), "name", String.class.getName(), 100);
        }
        else if (columnName.equals("price")) {
            builder.addColumn(getMessageSource().getMessage("label_book_price", null, "Price", locale), "price", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("expenses")) {
            builder.addColumn(getMessageSource().getMessage("label_book_expenses", null, "Expenses", locale), "expenses", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("circul")) {
            builder.addColumn(getMessageSource().getMessage("label_book_circul", null, "Circul", locale), "circul", Integer.class.getName(), 100);
        }
        else if (columnName.equals("publication")) {
            builder.addColumn(getMessageSource().getMessage("label_book_publication", null, "Publication", locale), "publication", Date.class.getName(), 100);
        }
        }
