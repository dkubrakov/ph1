...
import roo.ph.web.BooksCollectionJsonController;
...
privileged aspect BooksCollectionJsonController_Roo_JSON {
    ...
    declare @type: BooksCollectionJsonController: @RequestMapping(value = "/books", name = "BooksCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
