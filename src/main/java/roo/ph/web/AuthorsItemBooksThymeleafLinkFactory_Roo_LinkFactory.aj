...
import roo.ph.web.AuthorsItemBooksThymeleafLinkFactory;
...
privileged aspect AuthorsItemBooksThymeleafLinkFactory_Roo_LinkFactory {
     ...
     * 
     */
    public static final String AuthorsItemBooksThymeleafLinkFactory.DATATABLESBYIDSIN = "datatablesByIdsIn";
